...
export const metadata: Metadata = {
  ...
  description: 'Plataforma de formação cristã. Cursos online com área exclusiva para alunos, certificados e suporte.',
  ...
  openGraph: {
    ...
    description: 'Plataforma de formação cristã. Conhecimento que cria raízes e gera crescimento.',
    images: [{ url: '/og-image.png', width: 1200, height: 630, alt: 'Escola Seiva' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Escola Seiva — Cursos Online',
    description: 'Plataforma de formação cristã.',
    images: ['/og-image.png'],
  },
